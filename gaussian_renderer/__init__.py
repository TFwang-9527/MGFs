...
def render(iteration,viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, kernel_size: float, scaling_modifier = 1.0, override_color = None, subpixel_offset=None):
    """
    Render the scene. 
    ...
    raster_settings = GaussianRasterizationSettings(
        ...
        mask_image=viewpoint_camera.mask_image,
        tanfovx=tanfovx,
        tanfovy=tanfovy,
